...
\newcommand{\CondProb}[2]{\mathbb{P}\left[{#1}\mid {#2}\right]} % conditional expectation.
...
\newcommand{\statespace}{\mathcal{S}} % Symbol for the state space for a Markov process.
